...
OBJECTFILES= \
	${OBJECTDIR}/LED.o \
	${OBJECTDIR}/SysClock.o \
	${OBJECTDIR}/TIMER.o \
	${OBJECTDIR}/UART.o \
	${OBJECTDIR}/input_pa0_pa1_test.o \
	${OBJECTDIR}/main.o \
	${OBJECTDIR}/receipe_ideas.o
...
${OBJECTDIR}/SysClock.o: SysClock.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SysClock.o SysClock.c
...
${OBJECTDIR}/input_pa0_pa1_test.o: input_pa0_pa1_test.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/input_pa0_pa1_test.o input_pa0_pa1_test.c
...
${OBJECTDIR}/receipe_ideas.o: receipe_ideas.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/receipe_ideas.o receipe_ideas.c
