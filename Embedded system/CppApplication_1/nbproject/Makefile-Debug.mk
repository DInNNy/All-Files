...
${OBJECTDIR}/SysClock.o: SysClock.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SysClock.o SysClock.c
...
${OBJECTDIR}/input_pa0_pa1_test.o: input_pa0_pa1_test.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/input_pa0_pa1_test.o input_pa0_pa1_test.c
...
${OBJECTDIR}/receipe_ideas.o: receipe_ideas.c
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/receipe_ideas.o receipe_ideas.c
